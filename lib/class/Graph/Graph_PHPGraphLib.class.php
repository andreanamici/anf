<?php 
///////////////////////////////////////////////////////////
//Graph_PHPGraphLib -  PHP Graphing Library v2.31
...
class Graph_PHPGraphLib {
	...
	function Graph_PHPGraphLib($width = '', $height = '', $output_file = NULL) {
	...
	function displayErrors() {
		if (count($this->error) > 0) {
			...
			imagestring($this->image, 3, 2, 0, "!!----- Graph_PHPGraphLib Error -----!!",  $errorColor);
