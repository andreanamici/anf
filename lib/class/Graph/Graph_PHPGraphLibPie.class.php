<?php
///////////////////////////////////////////////////////////
//Graph_PHPGraphLib -  PHP Graphing Library v2.31 - Pie Chart Extension
//Author: Elliott Brueggeman
//PHP v4.04 + compatible
//Please visit www.ebrueggeman.com for usage policy
//and documentation + examples
///////////////////////////////////////////////////////////
class Graph_PHPGraphLibPie extends Graph_PHPGraphLib {
	...
	var $pie_3D_height;
	function Graph_PHPGraphLibPie($width = '', $height = '') {
		Graph_PHPGraphLib::Graph_PHPGraphLib($width, $height);	
	}
	function initialize() {
		Graph_PHPGraphLib::initialize();
	...
	function returnColorArray($color) {
		//THIS FUNCTION FIRST CHECKS EXISITNG COLORS IN Graph_PHPGraphLib
		//THEN IF NOT FOUND CHECKS ITS OWN LIST
		//COMES WITH VARIOUS PRESET LIGHTER PIE CHART FRIENDLY COLORS
		if ($resultColor = Graph_PHPGraphLib::returnColorArray($color)) {
			return $resultColor;
		}
		else {
			//REMOVE LAST ERROR GENERATED (Graph_PHPGraphLib::returnColorArray) SETS ONLY ONE ERROR IF FALSE)
	...
	//UNUSED Graph_PHPGraphLib FUNCTIONS OVERWRITTEN
