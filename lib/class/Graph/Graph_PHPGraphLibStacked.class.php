<?php
///////////////////////////////////////////////////////////
//Graph_PHPGraphLib -  PHP Graphing Library v2.31 - Stacked Bar Extension
//Author: Elliott Brueggeman
//PHP v4.04 + compatible
//Please visit www.ebrueggeman.com for usage policy
//and documentation + examples
///////////////////////////////////////////////////////////
class Graph_PHPGraphLibStacked extends Graph_PHPGraphLib {
	function Graph_PHPGraphLibStacked($width = '', $height = '') {
		Graph_PHPGraphLib::Graph_PHPGraphLib($width,$height);	
	}
	...
	function setLine() { $this->error[] = __function__ . '() function not allowed in Graph_PHPGraphLib Stacked extension.'; }
	function setDataPointSize() { $this->error[] = __function__ . '() function not allowed in Graph_PHPGraphLib Stacked extension.'; }
	function setDataPoints() { $this->error[] = __function__ . '() function not allowed in Graph_PHPGraphLib Stacked extension.'; }
	function setDataValues() { $this->error[] = __function__ . '() function not allowed in Graph_PHPGraphLib Stacked extension.'; }
}