...
abstract class BaseQuery implements IteratorAggregate {
   ...
   /**
    * Return FluentPDOstatement Object
    * 
    * @return FluentPDOstatement
    */
   public function getFluentStatement()
   {
      $query      = $this->buildQuery();
		$parameters = $this->buildParameters();
     
		$statement = $this->fpdo->getPdo()->prepare($query);
      
      $fluentStmt = new FluentPDOstatement();
      
      $fluentStmt->setStatement($statement)
